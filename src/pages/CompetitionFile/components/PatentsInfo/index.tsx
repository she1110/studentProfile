...
class PatentsInfo extends Component<Props> {
  state = {
  ...
  handleDownloadExcel = () => {
    ...
    //   payload: {
    //     type: '1',
    //     data: this.props.patentList,
    //   },
    // });
    const {patentList} = this.props;
    let payloadTemp: any = JSON.parse(JSON.stringify(patentList));
    ...
    axios({
      ...
      .then(function (res) {
        ...
        // 触发点击方法
        link.setAttribute('download', '专利统计表格');
          ...
          <ConfigProvider locale={zhCN}>
            <Form onFinish={this.onSearchFinish} ref={this.searchFormRef}>
              <Row gutter={[16, 0]}>
                ...
                <Col>
                  <Form.Item label="专利题目" name="proTitle">
                    <Input/>
                  </Form.Item>
                </Col>
                <Col>
