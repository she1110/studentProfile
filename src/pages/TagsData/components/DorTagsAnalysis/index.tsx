...
class DorTagsAnalysis extends Component<Props> {
  state = {
  ...
  render() {
    const {allDorInfo, allTagInfo} = this.props;
    const {
      selectedRowKeys,
      rowValue,
      modalAddVisible,
    ...
    return (
      <div>
        ...
        <ConfigProvider locale={zhCN}>
          <Form onFinish={this.onSearchFinish} ref={this.searchFormRef}>
            <Row gutter={[16, 0]}>
              ...
              <Col>
                <Form.Item label="宿舍号" name="dormitory">
                  <Input/>
                </Form.Item>
              </Col>
        ...
        <Card style={{marginBottom: 30}}>
          ...
          <Table
            columns={DorColumns}
            dataSource={allDorInfo}
            rowSelection={rowSelection}
            rowKey={(record: any) => record.dormitory}
          />
        </Card>
        {/* 添加标签 */}
        <Modal
